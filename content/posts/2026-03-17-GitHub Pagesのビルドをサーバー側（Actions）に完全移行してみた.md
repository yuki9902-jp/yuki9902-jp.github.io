...
## 手順
1. [GitHub設定の変更](#1GitHub設定の変更)
2. [.github/workflows に hugo.ymlを作成](#2github/workflowsディレクトリにhugoymlを作成)
3. [ルートに.gitignoreを作成](#3ルートにgitignoreを作成)
4. [サブモジュールの実体化 (テーマフォルダ)](#4サブモジュールの実体化 (テーマフォルダ))
5. [記事投稿時のgitコマンドを書き直す](#5記事投稿時のgitコマンド)
